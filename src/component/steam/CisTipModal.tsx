...
interface CisTipModalProps {
    click: () => void;
    modal: boolean;
}

function CisTipModal({ click, modal }: CisTipModalProps) {
            ...
            <div className="relative w-full h-full">
                ...
                >
                    <div className="flex items-center justify-between">
                        <p className="font-medium text-[20px]">Какие страны входят в СНГ?</p>
                        <img
                            src="/steam/cross.png"
                            alt="cross"
